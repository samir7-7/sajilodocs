    ...
    <div className="min-h-screen bg-[#0F172A] flex overflow-hidden font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-16 overflow-hidden">
        ...
        <div className="flex items-center gap-3 z-10">
          <div className="h-12 w-12 bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-indigo-500/20">
            <ShieldCheck size={28} />
          </div>
        ...
        <div className="z-10 max-w-lg">
          ...
          <h1 className="text-5xl font-extrabold text-white mb-8 leading-[1.1] tracking-tight">
            Elevate Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-indigo-300">Document Workflow</span>
          </h1>
          ...
          <div className="space-y-8">
            {[
              ...
              <div key={i} className="group flex items-start gap-5 transition-all duration-300 hover:translate-x-2">
                <div className="p-3 bg-white/5 border border-white/10 rounded-2xl text-indigo-400 group-hover:bg-indigo-600 group-hover:text-white transition-colors duration-300">
                  <item.icon size={22} />
                </div>
                <div>
        ...
        <div className="z-10 flex items-center gap-8 text-white/40">
           <div className="flex -space-x-3">
             ...
             <div className="h-10 w-10 rounded-full border-2 border-[#0F172A] bg-indigo-600 flex items-center justify-center text-[10px] font-bold text-white">+2k</div>
           </div>
