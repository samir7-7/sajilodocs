        ...
        <header className="h-16 border-b border-slate-100 bg-white sticky top-0 z-30 flex items-center justify-between px-8">
          <div className="flex-1 max-w-xl hidden sm:block">
            <div className="relative group">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#4f46e5] transition-colors" size={18} />
              <input 
                type="text" 
          ...
          <div className="flex items-center gap-4 ml-auto">
            <Link 
              ...
              className="p-2 text-slate-500 hover:bg-indigo-50 hover:text-[#4f46e5] rounded-full transition-all relative group"
            >
